          ...
          <div className="md:flex justify-center gap-20">
            ...
            <Fade up delay={500}>
              <div className="text-center relative px-4">
                ...
                <p className="text-gray max-w-sm">
                  Choose your preferred payment method such as bank transfer or credit card to top up your NairaCoin Wallet
                </p>
              </div>
            </Fade>
            <Fade up delay={1000}>
              <div className="text-center relative px-4">
                ...
                <p className="text-gray max-w-sm">
                  Sign up for your free NairaCoin Wallet on web, iOS or Android and follow our easy process to set up your profile
                </p>
              </div>
            </Fade>
          </div>
